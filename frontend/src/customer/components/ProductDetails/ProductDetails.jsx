    ...
    const fetchData = async () => {
      try {
        ...
        const [reviewsResponse, ratingsResponse] = await Promise.all([
          fetch(`http://localhost:5454/api/reviews/product/${productId}`),
          fetch(`http://localhost:5454/api/ratings/product/${productId}`),
        ]);

        if (!reviewsResponse.ok || !ratingsResponse.ok) {
          throw new Error("Failed to fetch reviews or ratings");
        }
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
                          ...
                          {size.inStock ? (
                            ...
                            >
                              <svg
                                ...
                                className="absolute inset-0 size-full stroke-2 text-gray-400"
                              >
                                <line
                                  x1={0}
                                  x2={100}
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">
                    {products.product?.details || "No details available."}
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mt-10">
          <h1 className="font-semibold text-lg pb-4">Write a Review</h1>
          {user ? (
            <ReviewRatingForm productId={productId} user={user} />
          ) : (
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-4">
                  <Rating
                    // value={4.6}
                    // value={products.product?.averageRating || 0}
                  ...
                  <p className="opacity-60">
                    {/* 56000 Ratings */}
                    {/* {products.product?.totalReviews || 0} Ratings */}
